...
def query_dynamodb(table,location, pk, sk1=None, sk2=None):
    transactions = []
    ...
    try:
        response = table.query(
            ...
            FilterExpression=Key('Thing_Organization_LocalBusiness_locationId').eq(location),
    ...
    while next_time <= end_date:
        ...
        try:
            ...
            if end_date.month == start_date.month and end_date.year == start_date.year:
                ...
                transactions = query_dynamodb(table, location,partition_key, sort_key_start, sort_key_end)
...
if __name__ == "__main__":
    event = {
        "body": "{\"start_date\": \"2022-12-01T00:00:00.000\", \"location_id\": \"19\"}"
